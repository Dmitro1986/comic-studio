...
## 5. Самые ценные улучшения (топ-5)

1. **WEB_PUBLIC_URL** — 5 минут настройки, сразу ссылки в Telegram
2. **Caption style families** — консистентность и качество captions без допcost
3. **Рендер-превью** — экономия MiniMax tokens перед approve
4. **Персонажи с памятью** — убирает главный косяк: персонаж "плавает" между панелями
5. **Автопубликация cron** — регулярный контент без ручного запуска
